...
class NidsScreen extends StatefulWidget {
  const NidsScreen({super.key});

  @override
  State<NidsScreen> createState() => _NidsScreenState();
}

class _NidsScreenState extends State<NidsScreen> {
...
class _NidsMetricsState extends State<NidsMetrics> {
  ...
  //     // Implement communication to send _selectedDirectory to the Rust engine.
  //     // This might involve:
